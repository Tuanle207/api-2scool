...
namespace Scool.Migrations
{
    ...
    [Migration("20220330162321_Config_Relationships_With_Account")]
    partial class Config_Relationships_With_Account
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Scool.Domain.Common.Account", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Scool.Domain.Views.DcpClassFault", b =>
                {
                    b.Property<Guid>("ClassId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Scool.Domain.Views.DcpClassRanking", b =>
                {
                    b.Property<Guid>("ClassId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Scool.Domain.Views.OverallClassRanking", b =>
                {
                    b.Property<Guid>("ClassId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Scool.Domain.Views.StudentWithMostFaults", b =>
                {
                    b.Property<string>("ClassName")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Scool.Domain.Common.Account", b =>
                {
                    ...
                    b.HasOne("Scool.Domain.Common.Student", "Student")
                        .WithOne()
                        .HasForeignKey("Scool.Domain.Common.Account", "StudentId");

                    b.HasOne("Scool.Domain.Common.Student", null)
                        .WithOne("Account")
                        .HasForeignKey("Scool.Domain.Common.Account", "StudentId1");

                    b.HasOne("Scool.Domain.Common.Teacher", "Teacher")
                        .WithOne()
                        .HasForeignKey("Scool.Domain.Common.Account", "TeacherId");

                    b.HasOne("Scool.Domain.Common.Teacher", null)
                        .WithOne("Account")
                        .HasForeignKey("Scool.Domain.Common.Account", "TeacherId1");
            ...
            modelBuilder.Entity("Scool.Domain.Common.Activity", b =>
                {
                    ...
                    b.HasOne("Scool.Domain.Common.Account", "CreatorAccount")
                        .WithMany()
                        .HasForeignKey("CreatorId");

                    b.HasOne("Scool.Domain.Common.Account", "LastUpdatorAccount")
                        .WithMany()
            ...
            modelBuilder.Entity("Scool.Domain.Common.TaskAssignment", b =>
                {
                    b.HasOne("Scool.Domain.Common.Account", "Assignee")
                        .WithMany()
