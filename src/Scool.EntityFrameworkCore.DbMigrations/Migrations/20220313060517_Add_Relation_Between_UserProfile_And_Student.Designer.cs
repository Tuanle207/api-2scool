...
namespace Scool.Migrations
{
    ...
    [Migration("20220313060517_Add_Relation_Between_UserProfile_And_Student")]
    partial class Add_Relation_Between_UserProfile_And_Student
    {
            ...
            modelBuilder.Entity("Scool.Domain.Common.Student", b =>
                {
                    ...
                    b.HasOne("Scool.Domain.Common.UserProfile", "UserProfile")
                        .WithOne("Student")
                        .HasForeignKey("Scool.Domain.Common.Student", "UserProfileId");
